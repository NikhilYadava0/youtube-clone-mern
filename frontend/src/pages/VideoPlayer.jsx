...
function VideoPlayer() {
    ...
    {video.videoLink?.includes("youtube.com") || video.videoLink?.length === 11 ? (
        // YouTube embed
        <iframe
            ...
            height="500"
            src={
                video.videoLink.length === 11
                    ? `https://www.youtube.com/embed/${video.videoLink}`
                    : `https://www.youtube.com/embed/${new URL(video.videoLink).searchParams.get("v")}`
            }
            frameBorder="0"
